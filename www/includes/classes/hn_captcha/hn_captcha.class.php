...
class hn_captcha
{
    ...
    *
    */
   function flush_captcha_image(){
      $image_path = $this->get_filename();
      ...
      $im = @imagecreatefromjpeg($this->get_filename());
      imagejpeg($im);
      imagedestroy($im);
      die();
   ...
   function get_gd_version()
   {
      ...
      if($gd_version_number === null)
      {
         ...
         if (function_exists('gd_info')){
            ...
            $module_info = (int)$gdInfoArr['GD Version'];
            
            if ($module_info == ''){
               #workaround to set bundled vesion of GD linb
               if ($gdInfoArr['GD Version'] != ''){
                  $module_info = 1;
               }
            }
